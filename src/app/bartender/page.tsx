...
import { ArrowLeft, Coffee, Clock, ChevronRight, Trash2, Loader2, CheckCircle } from "lucide-react";
...
export default function BartenderPage() {
  ...
  return (
    <div className="h-[calc(100vh-4rem)] flex flex-col overflow-hidden bg-ethiopian-cream">
      <div className="flex items-center justify-between px-6 py-4 border-b border-ethiopian-gold/10 bg-ethiopian-cream/95 backdrop-blur-sm">
        <div className="flex items-center gap-3">
          <Link href="/dashboard" className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-ethiopian-gold/20 to-ethiopian-clay/20 hover:from-ethiopian-gold/30 hover:to-ethiopian-clay/30 transition-all duration-200">
          ...
          <div>
            <h1 className="text-lg font-bold tracking-tight text-ethiopian-coffee font-serif">Bartender</h1>
            <p className="text-xs text-ethiopian-coffee/50">{orders.length} drink orders</p>
          </div>
        </div>
