        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-ethiopian-coffee/60">
              {pendingCount > 0 ? (
                <span className="text-ethiopian-burgundy font-semibold">{pendingCount} pending order{pendingCount > 1 ? "s" : ""}</span>
              ) : (
                "No pending orders"
              )}
            </p>
              ...
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    ...
                    <div>
                      <p className="text-xs text-ethiopian-coffee/40">{t("butcher.meatType")}</p>
                      <p className="text-sm font-semibold text-ethiopian-burgundy">{order.meatType}</p>
                    </div>
                    <div>
                      <p className="text-xs text-ethiopian-coffee/40">{t("butcher.portionSize")}</p>
                      <p className="text-sm font-semibold text-ethiopian-gold">{order.portionSize}</p>
                    </div>
                    <div>
                      <p className="text-xs text-ethiopian-coffee/40">{t("butcher.quantity")}</p>
