...
export default function ButcherDashboardPage() {
  ...
  const filters = [
    ...
    { value: "SENT_TO_KITCHEN", label: "In Kitchen", count: orders.filter((o) => o.status === "SENT_TO_KITCHEN").length },
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-[#3E2723]">Butcher Dashboard</h1>
      ...
      {/* Orders List */}
      {loading ? (
        <div className="text-center py-12 text-[#3E2723]/60">Loading...</div>
      ) : orders.length === 0 ? (
        <div className="text-center py-12">
          <Package className="w-12 h-12 text-[#C89B3C] mx-auto mb-3" />
          <p className="text-[#3E2723]/60">No orders found</p>
        </div>
      ) : (
              ...
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    ...
                    <div>
                      <p className="text-xs text-[#3E2723]/40">Meat Type</p>
                      <p className="text-sm font-semibold text-[#A12222]">{order.meatType}</p>
                    </div>
                    <div>
                      <p className="text-xs text-[#3E2723]/40">Portion</p>
                      <p className="text-sm font-semibold text-[#C89B3C]">{order.portionSize}</p>
                    </div>
                    <div>
                      <p className="text-xs text-[#3E2723]/40">Quantity</p>
